...
model = keras.models.Sequential([
    keras.layers.Dense(X_train.shape[1], activation='relu', input_shape=(X_train.shape[1],)),  # 64 = nombre de pixels d'une image 8x8
    keras.layers.Dense(32, activation='relu'),
    keras.layers.Dense(len(np.unique(y_train)), activation='softmax')  # 10 classes (0 à 9)
...
print("y_test score : ",model.evaluate(X_test,y_test))
